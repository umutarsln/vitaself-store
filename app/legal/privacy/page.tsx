    ...
    >
      <LegalContent
        tr={
          <>
            <p className="text-foreground/90">
              Son güncelleme: Eylül 2026. Bu metin, {seller.brand} web sitesi ve online mağaza
              üzerinden toplanan kişisel verilerin nasıl işlendiğini açıklar.
            </p>

            <LegalSection title="Veri sorumlusu">
              <p>
                Veri sorumlusu: {sellerLegalLabel()}. Gizlilik talepleri için:{' '}
                <a
            ...
            <LegalSection title="Topladığımız veriler">
              ...
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  Ödeme işlemi sırasında ödeme sağlayıcısına iletilen bilgiler (kart verileri{' '}
                  {seller.brand} sunucularında saklanmaz)
                </li>
            ...
            <LegalSection title="Veri paylaşımı">
              ...
              <ul className="list-disc space-y-2 pl-5">
                <li>Ödeme ve sipariş altyapısı (bağlanan ödeme sağlayıcısı)</li>
        ...
        en={
          <>
            <p className="text-foreground/90">
              Last updated: September 2026. This notice explains how personal data is processed when
              you use the {seller.brand} website and online store.
            </p>

            <LegalSection title="Data controller">
              <p>
                Controller: {sellerLegalLabel()}. Privacy requests:{' '}
                <a
                  href={`mailto:${seller.emails.privacy}`}
                  className="text-foreground underline-offset-4 hover:underline"
                >
            ...
            <LegalSection title="Data we collect">
              ...
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  Payment data handled by our payment provider (card details are not stored on{' '}
                  {seller.brand} servers)
                </li>
            ...
            <LegalSection title="Sharing">
              ...
              <ul className="list-disc space-y-2 pl-5">
                <li>Payment and order infrastructure (the connected payment provider)</li>
