export const tr = {
  ...
  benefits: {
    ...
    title: 'Klinik standart. Tam şeffaflık.',
    items: [
      {
        title: 'Klinik dozlar',
    ...
    items: [
      {
        ...
        dose: '200 mg',
        note: 'Sitrat, malat, bisglisinat + B6 — kas, sinir ve uyku',
        href: '/products/magnesium',
      },
      {
        name: 'Omega-3',
        dose: '600 mg',
        note: 'EPA 360 mg + DHA 240 mg — kalp, biliş ve eklem',
        href: '/products/omega-3',
      },
      {
        name: 'Erkekler için Multivitamin',
        dose: '18 aktif',
        note: 'Demirsiz formül — enerji, bağışıklık ve prostat',
        href: '/products/multivitamin-men',
      },
      {
        name: 'Kadınlar için Multivitamin',
        dose: '20 aktif',
        note: 'Demir, folat ve biotin — enerji, saç ve hormonal denge',
        href: '/products/multivitamin-women',
      },
      {
        name: 'Glikozamin Kompleks',
        dose: '1500 mg',
