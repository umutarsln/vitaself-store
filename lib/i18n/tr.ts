export const tr = {
  ...
  ingredients: {
    eyebrow: 'İçerikler',
    title: 'Formüllerimizin içinde ne var.',
    body: 'Magnezyum kas, sinir ve uyku için temeldir — formu, vücudun onu nasıl kullandığını değiştirir. Sitrat, malat ve bisglisinat ayrı iş görür. Glukozamin kıkırdağı destekler.',
    items: [
      {
        group: 'Magnezyum Kompleks',
        name: 'Magnezyum Sitrat',
        dose: 'Emilim',
        note: 'Emilimi yüksektir. Kas gevşemesi, enerji ve bağırsak motilitesini destekler.',
      },
      {
        group: 'Magnezyum Kompleks',
        name: 'Magnezyum Malat',
        dose: 'Enerji',
        note: 'Malik asitle bağlıdır. Hücresel enerji ve kas yorgunluğunda gündüz kullanımına uygundur.',
      },
      {
        group: 'Magnezyum Kompleks',
        name: 'Magnezyum Bisglisinat',
        dose: 'Uyku',
        note: 'Glisinle şelatlı, mideye nazik. Sakinlik ve gece toparlanmayı destekler.',
      },
      {
        group: 'Glukozamin Kompleks',
        name: 'Glukozamin Sülfat',
        dose: '1500 mg',
        note: 'Kıkırdak yapısının yapı taşı. Eklem konforu çalışmalarında en sık kullanılan doz.',
      },
      {
        group: 'Glukozamin Kompleks',
        name: 'Kondroitin Sülfat',
        dose: '1200 mg',
        note: 'Eklem yastıklamasını destekler; glukozaminle birlikte hareket rahatlığına katkı sağlar.',
      },
      {
        group: 'Glukozamin Kompleks',
        name: 'MSM',
        dose: '500 mg',
        note: 'Doğal kükürt kaynağı. Esneklik ve bağ dokusu konforunu destekler.',
      },
    ],
