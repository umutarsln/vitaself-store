export const en = {
  ...
  benefits: {
    ...
    title: 'Clinical standard. Full transparency.',
    items: [
      {
    ...
    items: [
      {
        ...
        dose: '200 mg',
        note: 'Citrate, malate, bisglycinate + B6 — muscle, nerve, and sleep',
        href: '/products/magnesium',
      },
      {
        name: 'Omega-3',
        dose: '600 mg',
        note: 'EPA 360 mg + DHA 240 mg — heart, cognition, and joints',
        href: '/products/omega-3',
      },
      {
        name: 'Multivitamin for Men',
        dose: '18 actives',
        note: 'Iron-free formula — energy, immunity, and prostate',
        href: '/products/multivitamin-men',
      },
      {
        name: 'Multivitamin for Women',
        dose: '20 actives',
        note: 'Iron, folate, and biotin — energy, hair, and hormonal balance',
