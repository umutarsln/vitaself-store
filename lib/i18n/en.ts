export const en = {
  ...
  nav: {
    ...
    shopMenuHint: 'Four clinical formulas. Transparent doses in every capsule.',
  },
  hero: {
  ...
  shop: {
    ...
    titleAccent: 'Nothing hidden.',
    body: 'Nine considered products. Transparent doses. The same pharmaceutical discipline behind every capsule.',
