export const en = {
  ...
  search: {
    ...
    sections: 'Section',
    legalGroup: 'Legal',
    hint: 'Try a product name, ingredient, or page title. Enter to go, Esc to close.',
  },
  hero: {
  ...
  ingredients: {
    eyebrow: 'Ingredients',
    title: 'What is actually inside our formulas.',
    body: 'Magnesium is essential for muscle, nerve, and sleep — the form changes how the body uses it. Citrate, malate, and bisglycinate each do different work. Glucosamine supports cartilage.',
    items: [
      {
        group: 'Magnesium Complex',
        name: 'Magnesium citrate',
        dose: 'Absorption',
        note: 'Highly absorbable. Supports muscle relaxation, energy, and regularity.',
      },
      {
        group: 'Magnesium Complex',
        name: 'Magnesium malate',
        dose: 'Energy',
        note: 'Bound to malic acid. Suited to daytime use for cellular energy and muscle fatigue.',
      },
      {
        group: 'Magnesium Complex',
        name: 'Magnesium bisglycinate',
        dose: 'Sleep',
        note: 'Chelated with glycine and gentle on the stomach. Supports calm and overnight recovery.',
      },
      {
        group: 'Glucosamine Complex',
        name: 'Glucosamine sulfate',
        dose: '1500 mg',
        note: 'A building block of cartilage. The dose most often used in joint-comfort studies.',
      },
      {
        group: 'Glucosamine Complex',
        name: 'Chondroitin sulfate',
        dose: '1200 mg',
        note: 'Supports joint cushioning and works alongside glucosamine for easier movement.',
      },
      {
        group: 'Glucosamine Complex',
        name: 'MSM',
        dose: '500 mg',
        note: 'A natural sulfur source. Supports flexibility and connective-tissue comfort.',
      },
    ],
